...
def faq_view(request):
    ...
    faqs = selectors.get_active_faqs(category_id=category_id or None)
    return render(request, "public_content/faq.html", {
        "faqs": faqs,
        "all_categories": FAQCategory.objects.all().order_by("name"),
